...
const details = [
  ...
  { love: "恋の始まり。スムーズなコミュニケーションができる。", work: "直感が冴え渡りワクワクを仲間と共有できる時。", relation: "気軽に話せる仲間との交流ができる時。", other: "選択と調和の象徴。協調性やつながり示します。" },
  ...
  { love: "情熱が過熱に変わりやすいので注意。泣かされる相手から離れる。", work: "執着や誘惑に注意し、冷静な判断を。再起のチャンス。", relation: "依存関係に気をつけて。", other: "束縛と欲望の象徴。子供心や初心を忘れずときめきを大事にして。" },
  { love: "突然の変化が訪れるかも。恐れず向き合って。", work: "計画が崩れる可能性あるが柔軟に対応をできる時。", relation: "価値観のリセット、再構築を経験するかも。", other: "破壊と解放の象徴。激変に対応できる。一新する覚悟が大事。" },
